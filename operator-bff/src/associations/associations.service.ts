...
export class AssociationsService {
  ...
  async findAll(page: number, limit: number) {
    try {
      ...
      const response: AxiosResponse = await firstValueFrom(
        this.httpService.get(`${this.operatorApiUrl}/api/associations`, {
          headers: {
  ...
  async findOne(id: string) {
    try {
      ...
      const response: AxiosResponse = await firstValueFrom(
        this.httpService.get(`${this.operatorApiUrl}/api/associations/${id}`, {
          headers: {
            'Accept': 'application/ld+json',
          },
        })
  ...
  async findMembers(associationId: string) {
    try {
      ...
      const response: AxiosResponse = await firstValueFrom(
        this.httpService.get(`${this.operatorApiUrl}/api/associations/${associationId}/members`, {
          headers: {
            'Accept': 'application/ld+json',
          },
        })
  ...
  async findEvents(associationId: string) {
    try {
      ...
      const response: AxiosResponse = await firstValueFrom(
        this.httpService.get(`${this.operatorApiUrl}/api/associations/${associationId}/events`, {
          headers: {
            'Accept': 'application/ld+json',
          },
        })
